...
int main()
{
    ...
    while (t--)
    {
        ...
        if (arr[0] == 1)
        { // this condition checks if the first element is "1" because we don't have power to swap or manipulate the first element i.e "1" other elements can be somehow swapped and sorted
            cout << "YES" << endl;
        }
        else
        { // if first element is not "1" the print no
            cout << "NO" << endl;
        }
    }
    return 0;
